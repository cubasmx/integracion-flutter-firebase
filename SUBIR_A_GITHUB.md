...
# Agregar el remoto
git remote add origin https://github.com/cubasmx/integracion-flutter-firebase.git
...
```bash
git remote add origin git@github.com:cubasmx/integracion-flutter-firebase.git
git push -u origin main
```
...
https://github.com/cubasmx/integracion-flutter-firebase
